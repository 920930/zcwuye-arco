<template>
  <div class="container">
    <Breadcrumb :items="['menu.list', '商户列表']" />
    <a-card class="general-card" title="列表">
      <a-row>
        <a-col :flex="1">
          <a-form :model="formModel" :label-col-props="{ span: 6 }" :wrapper-col-props="{ span: 18 }" label-align="left">
            <a-row :gutter="16">
              <a-col :span="8">
                <a-form-item field="number" label="商户姓名">
                  <a-input v-model="formModel.number" placeholder="商户姓名" />
                </a-form-item>
              </a-col>
              <a-col :span="8">
                <a-form-item field="name" label="商户手机号">
                  <a-input v-model="formModel.name" placeholder="商户手机号" />
                </a-form-item>
              </a-col>
              <a-col :span="8">
      ...
      <a-table row-key="id" :loading="loading" :pagination="pagination" :columns="(cloneColumns as TableColumnData[])" :data="renderData" :bordered="false" :size="size" @page-change="onPageChange">
