  ...
  <a-grid :cols="24" :row-gap="16" class="panel">
    <a-grid-item class="panel-col" :span="{ xs: 12, sm: 12, md: 12, lg: 12, xl: 12, xxl: 6 }">
      <a-space>
        ...
        <a-statistic title="商户总量" :value="373" :precision="1" :value-from="0" animation show-group-separator>
          <template #suffix>
    ...
    <a-grid-item class="panel-col" :span="{ xs: 12, sm: 12, md: 12, lg: 12, xl: 12, xxl: 6 }">
      <a-space>
        ...
        <a-statistic title="商铺总量" :value="368" :precision="1" :value-from="0" animation show-group-separator>
          <template #suffix>
    ...
    <a-grid-item class="panel-col" :span="{ xs: 12, sm: 12, md: 12, lg: 12, xl: 12, xxl: 6 }">
      <a-space>
        ...
        <a-statistic title="本月欠费" :value="8874" :value-from="0" animation show-group-separator>
          <template #suffix>
    ...
    <a-grid-item class="panel-col" :span="{ xs: 12, sm: 12, md: 12, lg: 12, xl: 12, xxl: 6 }" style="border-right: none">
      <a-space>
        ...
        <a-statistic title="闲置商铺" :value="28" :value-from="0" animation>
          <template #suffix>
            <span class="unit">{{ $t('workplace.pecs') }}</span>
          </template>
        </a-statistic>
